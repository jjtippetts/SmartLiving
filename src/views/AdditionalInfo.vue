  ...
  <section class="container">
    <div class="row justify-content-center align-items-center flex-column h-100">
      <div class="col-4">
        ...
        <p class="lead text-center">To help you accomplish your health goals we need to know a few details about you</p>
      </div>
      <div class="col-4 p-3 bg-light rounded-3 shadow-lg">
        <form class="row pb-3" novalidate @submit.prevent>
          ...
          <div class="col-12 form-floating pb-3">
            <input v-model="name.input" @change="validateName" id="name" class="form-control" v-bind:class="isNameValid"
          ...
          <div class="col-12 form-floating pb-3">
            ...
            <p v-if="weight.isValid === false" v-bind:class="weightFeedback" class="mb-0"> {{ weight.feedback }} </p>
          </div>
          <div class="col form-floating pb-3">
